...
<div class="container-fluid p-3 bg-light">
	<div class="row">
		...
		<div class="col-md-3 text-right">
			<a href="checkout.jsp" class=""><i
				class="fa-solid fa-cart-plus fa-2x "></i></a> <a href=""
				class="btn btn-success ml-2 mb-2"><i class="fa-solid fa-user"></i>
				<%=user.getName()%></a> <a href="logout"
				class="btn btn-danger ml-2 mb-2">Logout</a>
		</div>
		<%
		}
		%>
